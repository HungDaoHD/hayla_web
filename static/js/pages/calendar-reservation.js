(function () {
  ...
  var calendar_reservation = new FullCalendar.Calendar(document.getElementById('calendar-reservation'), {
    ...
    businessHours: { daysOfWeek: [0,1,2,3,4,5,6], startTime: '08:00', endTime: '22:30' },
    ...
    events: [
      {
        title: 'Hung',
        start: new Date(y, m, 14, 11, 30),
        end: new Date(y, m, 14, 18, 30),
